...
import Slider from "../superDailyProgram/Slider";
import "./Premium.css";
  ...
  <>
      ...
      <div className="banner-container">
        ...
        <div className="text-banner-part">
          ...
          <ul>
            ...
            <li>
              <i className="fa fa-check-circle" aria-hidden="true"></i> One Stop
              solution for baby's holistic Growth
            </li>
            <li>
              <i className="fa fa-check-circle" aria-hidden="true"></i>
        ...
        <div className="babies-card-list">
          <div class="baby-card">
            ...
            <div class="baby-card-text-part">
              <p>
                Rishit can observe 300+ fruits &amp; vegetables, Lets see how he
                does?
              </p>
            </div>
          </div>
    ...
    <section className="why-uptodd" id="why-uptodd">
      ...
      <div className="why-uptodd-slider-icons-mobile">
        <span
          className="slider-round-circle why-uptodd-dots active-slider-round-circle"
          onClick="currentWhyUpToddSlide(1)"
        ></span>
        <span
          className="slider-round-circle why-uptodd-dots"
          onClick="currentWhyUpToddSlide(2)"
        ></span>
        <span
          className="slider-round-circle why-uptodd-dots"
          onClick="currentWhyUpToddSlide(3)"
        ></span>
        <span
          className="slider-round-circle why-uptodd-dots"
          onClick="currentWhyUpToddSlide(4)"
        ></span>
      </div>
    </section>
    ...
    <section className="start-now-banner">
      ...
      <button
        ...
        onClick="showBookDemoPopup('startNowBanner')"
      >
        Start Now
      </button>
    </section>
        ...
        <div className="happy-parent-list">
          ...
          <div class="happy-parent-card">
            ...
            <div class="happy-parent-quote">
              ...
              />
              <p>
                Audio visual technology is creating a difference and has become
                a positive routine in my baby growth.
              </p>
            </div>
          </div>
          {/* 2 */}
          <div class="happy-parent-card">
            ...
            <div class="happy-parent-quote">
              ...
              />
              <p>
                Monthly developmental reports in Uptodd’s parenting program help
                me in identifying and resolving gaps in my baby brain
                development.
              </p>
            </div>
          </div>
          ...
          <div class="happy-parent-card">
            ...
            <div class="happy-parent-quote">
              <img
                ...
                alt="quote"
              />
              <p>Proud MOM of International Record Holder at UpTodd, Dhruvut</p>
            </div>
          </div>
        </div>
        <img
      ...
      <div className="product-cost-list">
        <div className="product-cost-card">
          ...
          <button
            ...
            onClick="showBuyProgramPopup('personalisedPage', 'INR 38,900', 
      'INR 120,900', 'c224d1aa-21ed-4c94-980f-760b115fec9b', 'Super Premium Program')"
          >
            Enroll Now
          </button>
        </div>
        <div className="product-cost-card">
          ...
          <button
            ...
            onClick="showBuyProgramPopup('personalisedPage', 'INR 23,900', 
      'INR 70,900', 'fb687b38-9d73-4d0f-bb02-7bc989fea9c1', 'Standard Premium Program')"
          >
            Enroll Now
          </button>
        </div>
