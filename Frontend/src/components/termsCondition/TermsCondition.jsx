    ...
    <div className="terms-container">
      ...
      <div className="terms-content">
        ...
        <p>
          ...
          information. Your use of the services and features of the Site shall
          be governed by these Terms and Conditions (hereinafter“Terms of Use“)
          along with the Privacy Policy, and Cancellation & Refund Policy
          (together “Policies“) as modified and amended from time to time.
          <br />
          <br />
          By mere accessing or using the Site, you are acknowledging, without
          limitation or qualification, to be bound by these Terms of Use and the
          Polices, whether you have read the same or not. ACCESSING, BROWSING OR
          OTHERWISE USING THE SITE INDICATES YOUR AGREEMENT TO ALL THE TERMS AND
          CONDITIONS IN THIS AGREEMENT, SO PLEASE READ THIS AGREEMENT CAREFULLY
          BEFORE PROCEEDING. If you do not agree to any of the terms enumerated
          in the Terms of Use or the Policies, please do not use the Site. You
          are responsible to ensure that your access to this Site and material
          available on or through it are legal in each jurisdiction, in or
        ...
        <p>
          You will be responsible for maintaining confidentiality of your
          account, password, and restricting access to your computer, and you
          hereby accept responsibility for all activities that occur under your
          account and password. You acknowledge that the information you
          ...
          resulting from such access or use of the Site.
          <br />
          <br />
        ...
        <p>
          Payments for the products available on the Site or on our Sub-Sites
          may be made in the following ways: Visa/MasterCard/Maestro Cards, Net
          Banking, Wallet, UPI.
        </p>

        <h2>7. CHAT FUNCTIONALITY</h2>
        <p>
          The Chat Functionality has been provided to help you with any and all
          Site related queries. Any use of this service shall be subject to the
          ...
          <ol>
            ...
            <li>
              ...
              information i.e. unlawful, threatening, abusive, defamatory,
              obscene information
            </li>
            <li>
              The chat room shall not be used by the end-user to sell any
              products, to give suggestion on business opportunity or any other
              form of solicitation
            </li>
            <li>
              You may proceed further and chat with our online customer care
              executive only if you agree to the above terms and conditions
            </li>
          </ol>
        </p>
        ...
        <p>
          ...
          User Content. You agree to not encourage or assist or engage others as
          ...
          <ol>
            ...
            <li>
              ...
              of any computer resource i. threatens the unity, integrity,
        ...
        <p>
          ...
          photographs, programs, music clips, downloads, video clips and written
          ...
          displayed on the Site for your personal use only. We also grant you a
          ...
          non-commercial use only. The Contents and software on this Site are to
        ...
        <p>
          ...
          in the Terms of Use. Your uninterrupted access or use of this Site on
          this basis may be prevented by certain factors outside our reasonable
          ...
          or assume that such information necessarily applies to them.
        </p>
        ...
        <p>
          ...
          IMPLIED, IN CONNECTION WITH THESE TERMS AND CONDITIONS OR THE SITE OR
          ANY OF THE CONTENT, INCLUDING BUT NOT LIMITED TO WARRANTIES OF
          MERCHANTABILITY, NON-INFRINGEMENT OR FITNESS FOR A PARTICULAR PURPOSE,
          EXCEPT TO THE EXTENT SUCH REPRESENTATIONS AND WARRANTIES ARE NOT
          LEGALLY EXCLUDABLE.
          <br />
          <br />
          ...
          (INCLUDING NEGLIGENCE) OR OTHERWISE) UNDER ANY CIRCUMSTANCES FOR ANY
          (a) INTERRUPTION OF BUSINESS; (b) ACCESS DELAYS OR ACCESS
          INTERRUPTIONS TO THE SITE; (c) DATA NON-DELIVERY, LOSS, THEFT,
          MISDELIVERY, CORRUPTION, DESTRUCTION OR OTHER MODIFICATION; (d) LOSS
          OR DAMAGES OF ANY SORT INCURRED AS A RESULT OF DEALINGS WITH OR THE
          PRESENCE OF OFF-WEBSITE LINKS ON THE SITE; (e) VIRUSES, SYSTEM
          ...
          SUBSIDIARIES, AFFILIATES, PARTNERS, OR LICENSORS WILL BE LIABLE FOR
          ANY INDIRECT, SPECIAL, PUNITIVE, INCIDENTAL, OR CONSEQUENTIAL DAMAGES
          OF ANY KIND (INCLUDING LOST PROFITS) RELATED TO THE SITE OR YOUR USE
          THEREOF REGARDLESS OF THE FORM OF ACTION WHETHER IN CONTRACT, TORT
          (INCLUDING NEGLIGENCE) OR OTHERWISE, EVEN IF WE HAVE BEEN ADVISED OF
          THE POSSIBILITY OF SUCH DAMAGES AND IN NO EVENT SHALL OUR MAXIMUM
          ...
          DISSATISFIED WITH THE SITE, TERMINATION OF YOUR USE OF THE SITE IS
        ...
        <h2>13. LINKS AND THIRD PARTY SITES</h2>
        <p>
        ...
        <p>
          ...
          expiry or termination of the Terms of Use.
        </p>

        <h2>16. GOVERNING LAW AND JURISDICTION</h2>
        <p>
          The Terms of Use and the Policies shall be construed in accordance
          with the applicable laws of India. For proceedings arising therein the
          Courts in Delhi shall have exclusive jurisdiction.
          <br />
          <br />
          Any dispute or difference either in interpretation or otherwise, of
          the Terms of Use and other Policies on the Site, between the parties
          hereto, shall be referred to an independent arbitrator who will be
          appointed by mutually and his decision shall be final and binding on
          the parties hereto. The above arbitration shall be in accordance with
        ...
        <p>
          ...
          <br />
          <br />
          Refund is not granted beyond these terms in any given condition as our
          entire team devotes huge amount of effort right from the start to
          provide best research based services to you and resources gets
          deployed immediately.
          <br />
          <br />
          We promise to give you everything personalised to help the baby in
          gaining much required developmental quotient as we maintained the
          relation with all parents enrolled with us, and served 98% WoW level
          happiness Index, which is leading in the entire parenting domain. We
          provide you dedicated support and ensure that all portions of your
          program is curated for you as per your child's developmental needs,
          and if you raise ticket around it then your dedicated POC resolve it
          immediately to provide 100% satisfaction within 48 hours.
          <br />
          <br />
          ...
          <ol style={{ "list-style-type": "number" }}>
            <li>6 Month/Mini Program : No Refund</li>
            <li>
              12 Month/Super Program : 45% of the Total Amount - EMI Charges
              discount(if any)
            </li>
            <li>28 days Program : No Refund</li>
          ...
          <br />
          For Cases before 4th October, 2024 -
          <ol style={{ "list-style-type": "number" }}>
            <li>6 Month : No Refund</li>
            <li>
              12 Month : 27% of the Total Amount - EMI Charges discount(if any)
            </li>
            <li>
              24 Month : 58% of the Total Amount - EMI Charges discount(if any)
            </li>
            <li>3 Month Program : No Refund</li>
          </ol>
          <br />
          <span>NOTE - </span>
          <ol style={{ "list-style-type": "number" }}>
            ...
            <li>
              ...
              your program is curated for you as per your child's developmental
              needs, and if you raise ticket around it then your dedicated POC
              resolve it immediately to provide 100% satisfaction
            </li>
          </ol>
          <br />
          ...
          offer applied become null and avoid, incase of rejoining request.
        </p>

        <h2>Payment Gateway and EMI</h2>
        <p>
          Its just a service to allow you pay the amount easily where we off
          interest charged by bank as a discount to you in cases where you
          select the relevant offers
          <br />
          <br />
          Any EMI choices made by you on payment gateway is completely your
          choice, bank EMI options are completely dependent on your bank's end,
          we don't have any relation to it.
          <br />
          <br />
        ...
        <p>
          ...
          <ol style={{ "list-style-type": "number" }}>
            ...
            <li>
              ...
              guidelines provided on your registered mail-id and registered
              number
            </li>
            <li>
              Any kit related issues should be informed within 12 hours of
              delivery, any concern raised after 12 hours will not be accepted
              as we thoroughly check the items before delivering it at the door.
            </li>
          </ol>
        </p>
        <br />
        ...
        <p>
          ...
          that it constitutes the complete and exclusive agreement between us
          concerning your use of the Site, and supersede and govern all prior
          proposals, agreements, or other communications.
          <br />
          <br />
          We reserve the right, in our sole discretion, to change/ alter/ modify
          these Terms and Conditions at any time by posting the changes on the
          Site. Any changes are effective immediately upon posting to the Site.
          Your continued use of the Site thereafter constitutes your agreement
          to all such changed Terms and Conditions. We may, with or without
          ...
          creating any agency, partnership, or other forms of joint enterprise
          ...
          hereof be taken or held to be a waiver of the provision itself. If any
          ...
          arbitral award or court decision, such unenforceability or invalidity
          shall not render these Terms and Conditions unenforceable or invalid
          as a whole but these Terms and Conditions shall be modified, to the
          extent possible, by the adjudicating entity to most fully reflect the
          original intent of the parties as reflected in the original provision.
          The headings in the Terms and Conditions are for convenience only and
