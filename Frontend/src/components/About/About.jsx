  ...
  return (
    <div>
      ...
      <section id='ourgoalsection'>
        <p>
          Our goal is to help every parent feel confident. Our play products are
          designed by child development experts and distilled to their simplest,
          purest purpose: to be exactly what children need at each stage.
        </p>
      </section>
      ...
      <section id='ourstorysection'>
        <div className='ourstory-container'>
          <div className='text'>
            ...
            <p>
              Welcome to the World of UpTodd early development! We are delighted
              to have you here. UpTodd was born from the dreams of three
              friends—Abhishek, Devesh, and Richa—who believed that every child
              deserves a bright and joyful start. Their journey began in the
              inspiring halls of IITs, driven by personal stories of resilience
              and hope. Sharing a common vision, they set out to bring a touch
              of wonder to early baby development.
            </p>
            <img
            ...
            <p>
              In 2015, Abhishek, Devesh, and Richa launched an NGO dedicated to
              giving every child a strong start in education. They noticed a
              common desire among parents: to offer the best for their
            ...
            <p>
              ...
              leading experts and researchers in the field of personalised baby
              growth and development. They delved into more than 10,000 research
              studies, driven by a passion to provide the best for every child.
              From MIT to Stanford, IITs to AIIMS, each piece of knowledge
              contributed to a recipe for an UpTodd early development
              environment filled with joy, creativity, and love. This
              collaboration led to a breakthrough understanding of the
      ...
      <section id='others'>
        <div>
          ...
          <p>
            ...
            common hope in every eye: to give their children the best start for
            customised baby growth and development. However, they also found a
            common guilt about having limited time and the overwhelming presence
            of screens and technology. This revealed a deeper concern about
            providing the right start in a world filled with challenges. The
            insights gathered from these interactions led to a deeper
            understanding of the impact of UpTodd early development experiences
            through play and environment.
          </p>
          ...
          <p>
            ...
            online to a worldwide community of over 150,000. It's a space where
            parents find support, share joyful moments, and witness their
            children's wonderful growth. Here, you'll find a community that’s
            like an extended family, celebrating every achievement with you.
          </p>
          <h2>Why You’ll Cherish UpTodd Early Development</h2>
          <p>
            Furthermore, our early development processes are specially designed
            for your child, making it exciting and joyful. Everything in baby
            development at Uptodd, from toys to stories, is created to spark
            curiosity and joy. Here, you'll find a supportive community
            celebrating each milestone with you. Our approach is scientifically
            sound and filled with warmth, ensuring a path of smiles and success
            for your baby.
          </p>
          <h2>Driven by Passion and Innovation</h2>
          <p>
            UpTodd’s uniquely crafted baby growth development programs are
            dedicated to offering something truly special. We provide everything
            from brain development support to nutrition and toys, all at an
            accessible cost.
          </p>
          <p>
            We're here to nurture, support, and celebrate the unique journey of
            every baby.
          </p>
          <h2>Join Our Story</h2>
          <p>
            We invite you to be part of this heartfelt journey. At Uptodd, we
            believe in the incredible potential within each child, just waiting
            to be nurtured.
          </p>
