      ...
      <div>
        <div className='focussection'>
          <h1>
            ...
            family that joins TEN-Toddlers thrives.
          </h1>
        </div>
            ...
            <div className='ourstory-container'>
              <div className='text'>
                ...
                <img
                  ...
                  loading='lazy'
                  alt='TEN-Toddlers baby growth'
                ></img>
                <h3>
                  Welcome to the World of TEN-Toddlers early development!{" "}
                </h3>
                <h4>Hello, Dear Parent!</h4>
                <p>
                  Welcome to the world of early development with TEN-Toddlers!
                  We’re thrilled to have you with us. TEN-Toddlers was founded
                  by three friends—Abhishek, Devesh, and Richa—who shared a
                  vision that every child deserves a bright and joyful
                  beginning. Their journey started in the inspiring halls of the
                  IITs, fueled by personal stories of resilience and hope.
                  United by their passion, they set out to bring a sense of
                  wonder to early childhood development.
                </p>
                <img
                ...
                <img
                  ...
                  loading='lazy'
                  alt='TEN-Toddlers baby development'
                ></img>
                ...
                <p>
                  ...
                  contributed to crafting the perfect environment for
                  TEN-Toddlers early development—one filled with joy,
                  creativity, and love. This collaboration led to a breakthrough
                  understanding of the importance of personalized baby growth.
                  In 2019, TEN-Toddlers early development was born—a place where
                  growth and happiness converge, providing individualized
                ...
                <img
                  ...
                  loading='lazy'
                  alt='TEN-Toddlers infant growth'
                ></img>
                <div id='imagecontainer'>
                  <img
                    src={additionalImage}
                ...
                <p>
                  ...
                  led to a profound understanding of the impact of TEN-Toddlers
                  early development, emphasizing the role of play and
                  environment in shaping a child’s growth.
                </p>
                <h3>Why TEN-Toddlers started</h3>
                <p>
                  Fueled by these insights, TEN-Toddlers’s journey took flight
                  in 2019, evolving from a single spark in India to a guiding
                  light in 158 countries. By viewing the world through the lens
                  of children's development, they saw boundless possibilities.
                  Their mission became clear: to give every baby the best start,
                  tailored specifically for them. TEN-Toddlers early baby
                  development strives to create a world where every baby, no
                  matter where they are, receives the right foundation for
                  growth.
                </p>
                <img
                  className='journey-background-img3'
                ...
                <p>
                  Building on this mission, TEN-Toddlers has expanded from a
                  simple online “hello” to a global community of over 150,000
                  members. It’s a space where parents find support, share joyful
                  moments, and witness their children’s remarkable growth. Here,
                  you’ll discover a community that feels like an extended
                  family, celebrating every milestone with you.
                </p>
                <h3>Why You’ll Cherish TEN-Toddlers Early Development</h3>
                <p>
                  Additionally, our early development processes are uniquely
                  designed for your child, making every step both exciting and
                  joyful. At TEN-Toddlers, everything—from toys to stories—is
                  crafted to ignite curiosity and happiness. You’ll find a
                  supportive community here, celebrating each milestone
                  alongside you. Our approach is rooted in science and infused
                  with warmth, ensuring a journey filled with smiles and success
                  for your baby.
                </p>
                <h3>Driven by Passion and Innovation</h3>
                <p>
                  TEN-Toddlers’s specially crafted baby growth development
                  programs are designed to offer something truly exceptional. We
                  provide comprehensive support, from brain development to
                  nutrition and toys, all at an affordable cost.
                </p>
                <p>
                ...
                <p>
                  We invite you to join us on this heartfelt journey. At
                  TEN-Toddlers, we believe in the incredible potential within
                  every child, waiting to be nurtured and supported.
                </p>
                ...
                <p>
                  At the heart of TEN-Toddlers are people like you—parents,
                ...
                ></img>
                <p>
                  Each day at TEN-Toddlers is a fresh start, filled with
                  laughter, growth, and love. Here’s to the incredible journey
                  ahead!
                </p>

                <p>
                  Welcome to TEN-Toddlers early development, where every day is
            ...
            <div className='doctor-review-container'>
              <div className='doctor-review-card'>
                ...
                <div className='doctor-review-quote'>
                  ...
                  />
                  <p>
                    TEN-Toddlers’s parenting program for baby maximizes baby
                    potential from the womb to 5 years, offering an impressive
                    solution for early baby brain development
                  </p>
                </div>
              </div>
              <div className='doctor-review-card'>
              ...
              <div className='doctor-review-card'>
                ...
                <div className='doctor-review-quote'>
                  ...
                  <p>
                    ...
                    TEN-Toddlers is doing great tech and research work to
                    nurture baby development through their parenting program
                  </p>
                </div>
              </div>
              <div className='doctor-review-card'>
                ...
                <div className='doctor-review-quote'>
                  ...
                  />
                  <p>
                    TEN-Toddlers, backed by the expertise of over 1K
                    professionals, nurtures their genius during the first 5
                    years with a comprehensive parenting program for baby
                  </p>
                </div>
              </div>
              <div className='doctor-review-card'>
                ...
                <div className='doctor-review-quote'>
                  ...
                  <p>
                    ...
                    baby's genius through TEN-Toddlers's baby parenting program
                  </p>
                </div>
              </div>
              <div className='doctor-review-card'>
                ...
                <div className='doctor-review-quote'>
                  ...
                  <p>
                    ...
                    optimal growth. TEN-Toddlers excels in nurturing babies'
                    brain abilities and supporting parents through a tailored
                    program
                  </p>
                </div>
              </div>
              <div className='doctor-review-card'>
                ...
                <div className='doctor-review-quote'>
                  ...
                  <p>
                    ...
                    occurs. TEN-Toddlers ensures perfect baby development with
              ...
              <div className='doctor-review-card'>
                ...
                <div className='doctor-review-quote'>
                  ...
                  <p>
                    ...
                    early cognitive care. TEN-Toddlers provides the best care
                    from womb to 60 months, laying a solid foundation for your
                    baby
                  </p>
                </div>
              </div>
              <div className='doctor-review-card'>
                ...
                <div className='doctor-review-quote'>
                  ...
                  />
                  <p>
                    TEN-Toddlers fosters 300% potential growth through
                    high-quality care from womb to 60 months, offering the
                    world's first one-stop solution in a parenting program for
                    your baby
                  </p>
                </div>
              </div>
              <div className='doctor-review-card'>
                ...
                <div className='doctor-review-quote'>
                  ...
                  />
                  <p>
                    At NICU, we see the impact of stimulation therapy.
                    TEN-Toddlers's products support it perfectly for babies,
                    integrated into their parenting program for babies
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className='our-mentors' id='our-mentors'>
            ...
            <div className='mentors-list'>
              <div className='mentor-card'>
                <img
                  ...
                  loading='lazy'
                  alt='TEN-Toddlers mentor Prof.Krishna Vedula MIT'
                />
                <h3>
                  Krishna Vedula
                  <br />
              ...
              <div className='mentor-card'>
                <img
                  ...
                  loading='lazy'
                  alt='TEN-Toddlers mentor Dr.Jaideep Sharma AIIMS'
                />
                <h3>
                  Dr. Jaideep Sharma
                  <br />
              ...
              <div className='mentor-card'>
                <img
                  ...
                  loading='lazy'
                  alt='TEN-Toddlers mentor Dr.Sudhanshu Singh'
                />
                <h3>
                  Dr. Sudhanshu
                  <br />
              ...
              <div className='mentor-card'>
                <img
                  ...
                  loading='lazy'
                  alt='TEN-Toddlers mentor Prof.Manoj Mondal IIT KGP'
                />
                <h3>
                  Manoj Mondal
                  <br />
              ...
              <div className='mentor-card'>
                <img
                  ...
                  loading='lazy'
                  alt='TEN-Toddlers mentor PK Mishra IIT BHU'
                />
                <h3>
                  Prof. PK Mishra
                  <br />
          ...
          <h1>TEN-Toddlers™ has been Featured In</h1>
          <div className='featured-in'>
            <img
              src='https://www.uptodd.com/images/newWebsite/featured-in.webp'
              loading='lazy'
              alt='Media Houses Featuring TEN-Toddlers'
            />
          </div>
        </div>
